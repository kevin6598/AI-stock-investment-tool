...
export default function SentimentPanel({ data, loading }: Props) {
  if (loading) {
    return (
      <div className="bg-card rounded-xl p-6 border border-gray-700 animate-pulse">
        ...
        <div className="border-t border-gray-700 pt-3 space-y-1">
          {s.event_direction !== 0 && (
            <div className="flex justify-between text-xs">
              <span className="text-gray-400">Event Signal</span>
              <span
                className={
          ...
          {s.macro_impact !== 0 && (
            <div className="flex justify-between text-xs">
              <span className="text-gray-400">Macro Impact</span>
              <span
